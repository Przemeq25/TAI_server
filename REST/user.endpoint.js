...
const userEndpoint = (router) => {
  router.post('/user/auth', async (request, response, next) => {
    try {
  ...
  router.post('/user/create', async (request, response, next) => {
    try {
  ...
  router.delete('/user/logout/:userId', auth, async (request, response, next) => {
    try {
